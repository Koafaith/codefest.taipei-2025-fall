...
| 參數 | 子參數 | 說明 | 範例 |
|------|--------|------|------|
| hero_banner | section_title | 首頁大標題文字 | "2025臺北秋季程式設計節" |
...
| title | 貼文標題 | "📢 最新消息｜2025臺北秋季程式設計節-城市通微服務大黑客松正式開跑！" |
| image_url | 貼文圖片路徑 | |
| content | 貼文內容，支援 HTML 格式與換行符號 \n | "讓數據發聲，開源創新！「2025臺北秋季程式設計節-城市通微服務大黑客松」 即將登場，首獎 30 萬，總獎金 70 萬，等你來挑戰！\n\n本競賽由臺北市政府資訊局與新北市政府資訊中心共同主辦..." |
